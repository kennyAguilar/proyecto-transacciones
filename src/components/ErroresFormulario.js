...
export const ErroresFormulario = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 sm:p-6 bg-gray-800 rounded-xl shadow-md space-y-4">
      ...
      <div className="space-y-2">
        <label className="block text-sm font-medium text-gray-300">Tipo de Error</label>
        <select
          name="tipoError"
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Cualquier nota adicional sobre el error"
        ></textarea>
      </div>
